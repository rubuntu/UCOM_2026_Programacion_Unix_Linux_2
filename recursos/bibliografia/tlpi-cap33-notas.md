# Notas de Estudio: TLPI CapÃ­tulo 33 (Subprocesos y Recursos)
...
- **Diferencia entre Fork y Clone:**
  ...
  - `clone()` permite seleccionar selectivamente quÃ© estructuras compartir (tabla de descriptores, espacio de nombres de red, espacio de memoria).
